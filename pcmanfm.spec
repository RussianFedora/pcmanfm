...
install -dD %{buildroot}/%{_sysconfdir}/skel/.config/pcmanfm/lxde
install -cpm 644 %{SOURCE1} %{buildroot}/%{_sysconfdir}/skel/.config/pcmanfm/lxde
...
%attr(0700, root, root) %dir %{_sysconfdir}/skel/.config/pcmanfm/lxde/
%config(noreplace) %{_sysconfdir}/skel/.config/pcmanfm/lxde/pcmanfm.conf
...
%changelog
* Fri Mar 11 2011 Arkady L. Shane <ashejn@yandex-team.ru>
- added pcmanfm.conf to /etc/skel for fixing missing background image
